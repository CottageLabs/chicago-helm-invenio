...
| Date | Step | Details |
|---|---|---|
| 25 Sep 2026 | 1 | Certificate `…62932abb-7ab9-4767-b8fb-be366ef6814b` (us-east-1) issued immediately; both validation records were already published. Two unused certificate requests from May 2026 in us-east-2 that had ended in `VALIDATION_TIMED_OUT` were deleted |
